class EarningDistribution
  ...
  attr_accessor :amount_to_distribute, :initial_date, :number_of_months, :actual_number_of_months, :by_shares
  ...
  def matrix
    ...
    return false if amount_to_distribute.to_d <= 0 && !by_shares
    ...
    def matrix_by_share_holder matrix
      ...
      0.upto(number_of_share_holders) do |share_holder_index|
        ...
        0.upto(actual_number_of_months) do |month_index|
          new_matrix[share_holder_index][month_index] = matrix[month_index][share_holder_index].is_a?(Array) ? matrix[month_index][share_holder_index][actual_index] : matrix[month_index][share_holder_index]
        end
      end
      new_matrix
    end
